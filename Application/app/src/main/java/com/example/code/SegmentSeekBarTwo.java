...
public class SegmentSeekBarTwo extends AppCompatSeekBar {
    ...
    public SegmentSeekBarTwo(Context context) {
        super(context);
        init();
    }

    public SegmentSeekBarTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SegmentSeekBarTwo(Context context, AttributeSet attrs, int defStyleAttr) {
